...
### Допустим, вам понадобилось или вы решили изучать математику, статистику, теорию вероятности, DataScience, BigData, BlockChain, IoT, и т.д.

Большинство людей все равно изучают приблизительно то же самое, по тем же самым источникам. Если встречаете, что-то полезное, что нужно записать, оставляйте ссылки на то, куда вы это записываете (гитхаб, блог, ворд документ). Если встречаете, очень полезные материалы, делитесь своими находками.

<br/>

Материал сайта обновляется по мере освоения новых знаний. Вы можете принять участие в корректировке и добавлении знаний.

<br/>

Больше всего интересуют примеры применения знаний, требующих аналитики и вычислений из реальной жизни. Особенно общественно значимые.
...
<div align="center">
    <iframe width="853" height="480" src="https://www.youtube.com/embed/TvmaHDpWm8g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>

<br/>

[Подробнее](https://rs.school/machine-learning/)
...
- Есть исходники.
- Есть записи с разбором книги (на английском).
...
**Точка входа (для тех кто не шарит)**  
...
### [YouTube] [teach-in] Лекции ученх МГУ [RUS, 2021]
...
**UPD. Есть предположение, что материалы теперь доступны на сайте openedu.**
